...
from seldom.Base_seldom.driver.webdriver import WebElement
...
class Steps(object):
    ...
    def open(self, url: str = None):
        ...
        if self.url is not None:
            ...
            SeldomConfig.driver.get(self.url)
        else:
            log.info("📖 {}".format(url))
    ...
    def alert(self):
        ...
        """
        log.info("🔍 alert.")
        self.alert_obj = SeldomConfig.driver.switch_to.alert
        return self
