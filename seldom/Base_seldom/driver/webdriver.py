...
from seldom.Base_seldom.utils.webdriver_manager_extend import ChromeDriverManager
...
class WebElement(object):
    ...
    def __find_element(self, elem: tuple) -> None:
        ...
        """
        for _ in range(SeldomConfig.timeout):
            elems = SeldomConfig.driver.find_elements(by=elem[0], value=elem[1])
            if len(elems) >= 1:
    ...
    def get_elements(self, index: int = None):
        ...
        if self.by == "id_":
            ...
            elem = SeldomConfig.driver.find_elements(By.ID, self.value)
        elif self.by == "name":
            self.__find_element((By.NAME, self.value))
            elem = SeldomConfig.driver.find_elements(By.NAME, self.value)
        elif self.by == "class_name":
            self.__find_element((By.CLASS_NAME, self.value))
            elem = SeldomConfig.driver.find_elements(By.CLASS_NAME, self.value)
        elif self.by == "tag":
            self.__find_element((By.TAG_NAME, self.value))
            elem = SeldomConfig.driver.find_elements(By.TAG_NAME, self.value)
        elif self.by == "link_text":
            self.__find_element((By.LINK_TEXT, self.value))
            elem = SeldomConfig.driver.find_elements(By.LINK_TEXT, self.value)
        elif self.by == "partial_link_text":
            self.__find_element((By.PARTIAL_LINK_TEXT, self.value))
            elem = SeldomConfig.driver.find_elements(By.PARTIAL_LINK_TEXT, self.value)
        elif self.by == "xpath":
            self.__find_element((By.XPATH, self.value))
            elem = SeldomConfig.driver.find_elements(By.XPATH, self.value)
        elif self.by == "css":
            self.__find_element((By.CSS_SELECTOR, self.value))
            elem = SeldomConfig.driver.find_elements(By.CSS_SELECTOR, self.value)
        else:
            raise NameError(
    ...
    def show_element(elem):
        ...
        if SeldomConfig.debug is True:
            for _ in range(2):
                SeldomConfig.driver.execute_script(style_red, elem)
                time.sleep(0.2)
                SeldomConfig.driver.execute_script(style_blue, elem)
                time.sleep(0.2)
            SeldomConfig.driver.execute_script(style_blue, elem)
            time.sleep(0.2)
            SeldomConfig.driver.execute_script(style_null, elem)
        else:
            for _ in range(2):
                SeldomConfig.driver.execute_script(style_red, elem)
                time.sleep(0.1)
...
class WebDriver(object):
    ...
    def visit(url: str) -> None:
        ...
        """
        log.info("📖 {}".format(url))
        if isinstance(SeldomConfig.driver, SeleniumWebDriver) is False:
            SeldomConfig.driver = Chrome(executable_path=ChromeDriverManager().install())
        SeldomConfig.driver.get(url)
    ...
    def max_window() -> None:
        ...
        Usage:
            self.max_window()
        """
        SeldomConfig.driver.maximize_window()
    ...
    def set_window(wide: int = 0, high: int = 0) -> None:
        ...
        """
        SeldomConfig.driver.set_window_size(wide, high)
    ...
    def slow_click(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(SeldomConfig.driver).move_to_element(elem).click(elem).perform()
    ...
    def right_click(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(SeldomConfig.driver).context_click(elem).perform()
    ...
    def move_to_element(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(SeldomConfig.driver).move_to_element(elem).perform()
    ...
    def click_and_hold(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(SeldomConfig.driver).click_and_hold(elem).perform()
    ...
    def drag_and_drop_by_offset(index:int = 0, x: int = 0, y: int = 0, **kwargs) -> None:
        ...
        elem = web_elem.get_elements(index)
        web_elem.show_element(elem)
        action = ActionChains(SeldomConfig.driver)
    ...
    def double_click(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(SeldomConfig.driver).double_click(elem).perform()
    ...
    def execute_script(script: str, *args):
        ...
        """
        return SeldomConfig.driver.execute_script(script, *args)
    ...
    def get_title(self) -> str:
        ...
        Usage:
            self.get_title()
        """
        log.info("✅ get title: {}.".format(SeldomConfig.driver.title))
        return SeldomConfig.driver.title
    ...
    def get_url(self) -> str:
        ...
        Usage:
            self.get_url()
        """
        log.info("✅ get current url: {}.".format(SeldomConfig.driver.current_url))
        return SeldomConfig.driver.current_url
    ...
    def get_alert_text(self) -> str:
        ...
        Usage:
            self.get_alert_text()
        """
        log.info("✅ alert text: {}.".format(SeldomConfig.driver.switch_to.alert.text))
        return SeldomConfig.driver.switch_to.alert.text
    ...
    def wait(secs: int = 10) -> None:
        ...
        SeldomConfig.driver.implicitly_wait(secs)
    ...
    def accept_alert() -> None:
        ...
        SeldomConfig.driver.switch_to.alert.accept()
    ...
    def dismiss_alert() -> None:
        ...
        SeldomConfig.driver.switch_to.alert.dismiss()
    ...
    def switch_to_frame(index: int = 0, **kwargs) -> None:
        ...
        SeldomConfig.driver.switch_to.frame(elem)
    ...
    def switch_to_frame_out() -> None:
        ...
        SeldomConfig.driver.switch_to.default_content()
    ...
    def switch_to_window(window: int) -> None:
        ...
        all_handles = SeldomConfig.driver.window_handles
        SeldomConfig.driver.switch_to.window(all_handles[window])
    ...
    def screenshots(self, file_path: str = None) -> None:
        ...
        if SeldomConfig.debug is True:
            ...
            SeldomConfig.driver.save_screenshot(file_path)
        else:
            log.info("📷️  screenshot -> HTML report.")
            self.images.append(SeldomConfig.driver.get_screenshot_as_base64())
    ...
    def get_cookies() -> list:
        ...
        Usage:
            self.get_cookies()
        """
        return SeldomConfig.driver.get_cookies()
    ...
    def get_cookie(name: str) -> dict:
        ...
        """
        return SeldomConfig.driver.get_cookie(name)
    ...
    def add_cookie(cookie_dict: dict) -> None:
        ...
        if isinstance(cookie_dict, dict):
            SeldomConfig.driver.add_cookie(cookie_dict)
        else:
        ...
        if isinstance(cookie_list, list):
            for cookie in cookie_list:
                if isinstance(cookie, dict):
                    SeldomConfig.driver.add_cookie(cookie)
                else:
                    raise TypeError("Wrong cookie type.")
        else:
            raise TypeError("Wrong cookie type.")
    ...
    def delete_cookie(name: str) -> None:
        ...
        """
        SeldomConfig.driver.delete_cookie(name)
    ...
    def delete_all_cookies() -> None:
        ...
        """
        SeldomConfig.driver.delete_all_cookies()
    ...
    def check_element(css: str = None) -> None:
        ...
        ret = SeldomConfig.driver.execute_script(js)
        if len(ret) > 0:
