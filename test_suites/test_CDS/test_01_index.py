...
from test_suites.test_CDS import *
...
class Index(unittest.TestCase):
    ...
    def test_01_login(self):
        """登录"""
        self.bd.send_keys(self.bd.account, "admin")
        self.bd.send_keys(self.bd.password, "123456")
        self.bd.click(self.bd.login_but)
        self.assertTrue(self.bd.wait((self.bd.login_but)))
